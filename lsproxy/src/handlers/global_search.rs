...
use crate::api_types::{ErrorResponse, GlobalSearchRequest, Symbol};
use crate::AppState;
...
pub async fn global_search(
    data: Data<AppState>,
    info: Query<GlobalSearchRequest>,
) -> HttpResponse {
    info!(
    ...
    match manager.global_search_ast_grep(&info.file_path,&info.target).await {
        Ok(symbols) => {
